...
- (void)resetFrame {
    ...
    self.backView.frame = CGRectMake((self.bounds.size.width - width) / 2, (self.bounds.size.height - heightWithMsg) / 2, width + 20, heightWithMsg);
...
- (void)createBackView {
    self.backView = [[UIView alloc]initWithFrame:CGRectMake((self.bounds.size.width - backViewWidth) / 2,(self.frame.size.height - backViewWidth) / 2, backViewWidth, backViewHeight)];
    self.backView.center = self.center;
